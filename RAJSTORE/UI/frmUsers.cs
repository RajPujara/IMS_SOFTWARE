    ...
    public partial class frmUsers : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (txtFirstName.Text == "" || txtLastName.Text == "" || txtEmail.Text == "" 
                || txtUsername.Text == "" || txtPassword.Text == "" || txtContact.Text == "" || txtAddress.Text == "")
            {
                MessageBox.Show("Please fill your detail first", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
